...
angular
    .module('starter')
    .controller('MCommerceProductViewController', function ($cordovaSocialSharing, Loader, $log, $state,
                                                            $stateParams, $scope, $translate, Analytics,
                                                            Application, Dialog, McommerceCategory, $timeout,
