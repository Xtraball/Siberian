...
angular.module('starter')
    .controller('MCommerceSalesConfirmationViewController',
        function (Loader, $location, $rootScope, $scope, $state, $stateParams, $timeout, $translate,
...
angular.module('starter')
    ...
    Dialog
    .alert('', 'The payment has been cancelled, something wrong happened? Feel free to contact us.', 'OK')
    .then(function () {
