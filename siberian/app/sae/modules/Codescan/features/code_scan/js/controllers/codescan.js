angular.module("starter").controller('CodeScanController', function ($ionicHistory, $rootScope, $scope, $timeout,
                ...
                for (var i = 0; i < $scope.scan_protocols.length; i++) {
                    if (barcodeData.text.toLowerCase().indexOf($scope.scan_protocols[i]) === 0) {
                        ...
                        .then(function (result) {
                            ...
                            if (result) {
                                cordova.plugins.clipboard.copy(barcodeData.text).then(function () {
                                }, function () {
                                });
                            }
