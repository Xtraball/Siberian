...
//<div class="col-md-12"><div class="alert alert-warning">' . p__('application', 'Latest store updates require you to register an AdMob app, and set the ID below.') . '</div></div>';
        ...
        $htmlAdmobAppId = '
<div class="col-md-12"><div class="alert alert-danger">' . p__('application', 'AdMob is temporary unavailable due to major changes & policies on stores with unmaintained Cordova updates.') . '</div></div>';
        $this->addSimpleHtml(
            'html_admob_app_id',
            $htmlAdmobAppId);

        // Early return to break form
        return;
//
