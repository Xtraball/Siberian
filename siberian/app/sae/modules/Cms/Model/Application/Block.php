...
class Cms_Model_Application_Block extends Core_Model_Default
{
     ...
     * @var string
     */
    protected $_db_table = Cms_Model_Db_Table_Application_Block::class;
    ...
    public function _toJson($base_url)
    {
        ...
        switch ($this->getType()) {
            case 'address':
                ...
                $block_data['show_phone'] = (bool) ($block_data['show_phone']);
                $block_data['show_website'] = (bool) ($block_data['show_website']);
                $block_data['show_address'] = (bool) ($block_data['show_address']);
                $block_data['show_geolocation_button'] = (bool) ($block_data['show_geolocation_button']);

                break;
            case 'button':
                $image = path('/images/application/' . $this->getIcon());
