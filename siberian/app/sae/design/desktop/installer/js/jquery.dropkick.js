...
(function ($, window, document) {
  ...
  var
    ...
    dropdownTemplate = [
      '<div class="dk_container {{ classname }}" id="dk_container_{{ id }}" tabindex="{{ tabindex }}">',
        '<a class="dk_toggle select">',
          '<span class="dk_label">{{ label }}</span>',
          '<span class="select-icon" data-image="339" data-style="select" data-color="color"></span>',
        '</a>',
        '<div class="dk_options" data-image="340" data-style="select" data-color="background_color">',
    ...
    optionTemplate = '<li class="{{ current }} select"><a data-dk-dropdown-value="{{ value }}">{{ text }}</a></li>',
  ...
  methods.init = function (settings) {
    ...
    return this.each(function () {
      ...
      $dk.find('.dk_options').css({opacity : 0});
      ...
      $dk.bind('focus.dropkick', function (e) {
        $dk.addClass('dk_focus');
          ...
          if(/MSIE/.test(navigator.appVersion)) return;
          _closeDropdown($dk);
//          $dk.find('.dk_options').animate({ top : 0, opacity: 0}, 300, null, function() {
//            $(this).hide();
...
//          });
  ...
  function _closeDropdown($dk) {
    $dk.find('.dk_options').animate({ top : $dk.find('.dk_toggle').height() / 2, opacity: 0}, 200, null, function() {
        $dk.removeClass('dk_open dk_focus');
        $(this).hide();
    });
//    $dk.removeClass('dk_open dk_focus');
  ...
  function _openDropdown($dk) {
    ...
    if(!$dk.hasClass('dk_open')) {
        $dk.addClass('dk_open dk_focus');
        $dk.find('.dk_options').show().animate({ top : $dk.find('.dk_toggle').outerHeight() - 1, opacity: 1 }, 200);
    }
    else {
        _closeDropdown($dk);
    }
