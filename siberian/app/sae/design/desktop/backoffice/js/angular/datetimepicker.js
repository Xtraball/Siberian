...
angular.module('ui.bootstrap.datetimepicker', [])
    ...
    .directive('datetimepicker', ['dateTimePickerConfig', function (defaultConfig) {
        ...
        return {
            restrict: 'E',
            require: 'ngModel',
            template: "<div class='datetimepicker' ng-show='isVisible'>" +
            "<span data-ng-click='isVisible = false' class='fa fa-remove'></span>" +
            ...
            "           <th class='switch' colspan='4'>" +
            "               <span data-ng-click='changeView(data.previousView, data.currentDate, $event)'" +
            ">{{ data.title }}</span></th>" +
            "           <th class='right'" +
            ...
            link: function (scope, element, attrs) {
                ...
                var dataFactory = {
                    ...
                    setTime: function (unixDate) {
                        ...
                        month = ("0" + tempDate.getMonth()).slice(-2);
                ...
                var getUTCTime = function () {
                    ...
                    if(scope.ngModel) {
                        scope.displayedDate = moment(scope.ngModel).format(configuration.format);
                    }
                ...
                scope.$watch('ngModel', function (val) {
                    ...
                    if(val) {
                        scope.displayedDate = moment(val).format(configuration.format);
                    }
                });
            }
        };
