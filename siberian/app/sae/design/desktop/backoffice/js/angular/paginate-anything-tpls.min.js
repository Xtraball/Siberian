        ...
        return {
            ...
            controller: ['$scope', '$attrs', '$http', function($scope, $attrs, $http) {
                ...
                function requestRange(request) {
                    ...
                    /** @Siberian, save original perPage in case of smaller result */
                    ...
                    responsePromise.then(function (rsp) {
                        ...
                        if(response) {
                            ...
                            if(length(response) <= response.total) {
                                /** @Siberian, <= unless of < & `( response.total >= 1 ) ||` */
                                if(
