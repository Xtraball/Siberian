...
(function() {
    ...
    .directive('rnCarousel', ['$swipe', '$window', '$document', '$parse', '$compile', '$interval', '$rootScope', function($swipe, $window, $document, $parse, $compile, $interval, $rootScope) {
        ...
        return {
            ...
            compile: function(tElement, tAttributes) {
                ...
                return function(scope, iElement, iAttributes, containerCtrl) {
                    ...
                    if (angular.isDefined(iAttributes.rnCarouselHeightScale)) {
                        heightScale = iAttributes.rnCarouselHeightScale;
                    }

                    if (iAttributes.rnCarouselAutoSlide!==undefined) {

                        if (angular.isDefined(iAttributes.rnCarouselLoopAtBeginning)) {
                            loopBackward = !eval(iAttributes.rnCarouselLoopAtBeginning);
                        }
                    ...
                    function updateContainerWidth() {
                        ...
                        if(heightScale) updateContainerHeight();
                    }

                    function updateContainerHeight() {
                        var width = getCarouselWidth();
                        if (width) {
                            container.css('height', width/heightScale + 'px');
                        }
                    }
