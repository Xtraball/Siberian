...
.controller('RssGroupController', function ($filter, $scope, $state, $stateParams, Rss, Pages) {
...
.controller('RssListController', function ($filter, $scope, $state, $stateParams, Rss, Pages) {
    angular.extend($scope, {
        is_loading: true,
        value_id: $stateParams.value_id,
