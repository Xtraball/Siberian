...
angular
.module('starter')
.directive('sbVideo', function($timeout, $window, YouTubeAutoPauser) {
    return {
        restrict: 'A',
        replace: true,
        scope: {
        ...
        template:
            ...
            '        ng-click="play()">' +
            '       <div ng-hide="use_iframe || use_video_element"' +
            '            ng-style="height_style">' +
