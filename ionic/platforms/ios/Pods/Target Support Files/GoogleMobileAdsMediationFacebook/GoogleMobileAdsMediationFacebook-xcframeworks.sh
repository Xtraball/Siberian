...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationFacebook/FacebookAdapter-6.9.0.0/FacebookAdapter.xcframework" "FacebookAdapter" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
