    ...
    BannerAd.prototype.load = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, shared_1.execAsync(shared_1.NativeActions.bannerLoad, [
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, shared_1.execAsync(shared_1.NativeActions.bannerShow, [{ id: this.id }])];
                }
            });
        });
    };
    BannerAd.prototype.hide = function () {
        return shared_1.execAsync(shared_1.NativeActions.bannerHide, [{ id: this.id }]);
    };
    return BannerAd;
}(shared_1.MobileAd));
