...
export * from './api';
export { AppOpenAd, BannerAd, BannerAdOptions, InterstitialAd, ManagedNativeAd, NativeAd, RewardedAd, RewardedAdOptions, RewardedInterstitialAd, RewardedInterstitialAdOptions, ServerSideVerificationOptions, };
export declare class AdMob {
    ...
    readonly ManagedNativeAd: typeof ManagedNativeAd;
