...
gulp.task("compress_js", function() {
    ...
    gulp.src(providers)
        .pipe(concat("providers.bundle.js", {newLine: ';'}))
        .pipe(minify({
            mangle: false,
            ext: {
                min: ".min.js"
        ...
        .pipe(gulp.dest("./www/js/providers/"));
    ...
    gulp.src(directives)
        .pipe(concat("directives.bundle.js", {newLine: ';'}))
        .pipe(minify({
            mangle: false,
            ext: {
                min: ".min.js"
        ...
        .pipe(gulp.dest("./www/js/directives/"));
    ...
    gulp.src(services)
        .pipe(concat("services.bundle.js", {newLine: ';'}))
        .pipe(minify({
            mangle: false,
            ext: {
                min: ".min.js"
    ...
    gulp.src(utils)
        .pipe(concat("utils.bundle.js", {newLine: ';'}))
        .pipe(minify({
            mangle: false,
            ext: {
                min: ".min.js"
    ...
    gulp.src(libraries_bundle)
        .pipe(concat("libraries.bundle.min.js", {newLine: ';'}))
        .pipe(gulp.dest("./www/js/libraries/"));
    ...
    gulp.src(features)
        .pipe(concat("features.bundle.js", {newLine: ';'}))
        .pipe(minify({
            mangle: false,
            ext: {
                min: ".min.js"
...
gulp.task("bundle_libs", function() {
    ...
    gulp.src(js_src_lib)
        .pipe(concat("app.libs.js", {newLine: ';'}))
        .pipe(minify({
            mangle: false,
            ext: {
                min: ".min.js"
