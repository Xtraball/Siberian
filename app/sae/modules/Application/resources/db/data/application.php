...
$datas = array(
    ...
    array('name' => 'Layout 3 - Full',         'visibility' => Application_Model_Layout_Homepage::VISIBILITY_HOMEPAGE, 'code' => 'layout_14', 'preview' => '/customization/layout/homepage/layout_14.png', 'use_more_button' => 0, 'use_horizontal_scroll' => 1, "number_of_displayed_icons" => 4,     'position' => "bottom", "order" => 38, "is_active" => 1),
    array('name' => 'Layout 5 - Full',         'visibility' => Application_Model_Layout_Homepage::VISIBILITY_HOMEPAGE, 'code' => 'layout_15', 'preview' => '/customization/layout/homepage/layout_15.png', 'use_more_button' => 0, 'use_horizontal_scroll' => 1, "number_of_displayed_icons" => 4,     'position' => "bottom", "order" => 58, "is_active" => 1),
    array('name' => 'Layout 11 - Fullscreen',  'visibility' => Application_Model_Layout_Homepage::VISIBILITY_HOMEPAGE, 'code' => 'layout_16', 'preview' => '/customization/layout/homepage/layout_16.png', 'use_more_button' => 0, 'use_horizontal_scroll' => 1, "number_of_displayed_icons" => 4,     'position' => "bottom", "order" => 110, "is_active" => 1),
    array('name' => 'Layout 12 - Metro',       'visibility' => Application_Model_Layout_Homepage::VISIBILITY_HOMEPAGE, 'code' => 'layout_17', 'preview' => '/customization/layout/homepage/layout_17.png', 'use_more_button' => 0, 'use_horizontal_scroll' => 1, "number_of_displayed_icons" => 4,     'position' => "bottom", "order" => 120, "is_active" => 1)
);
