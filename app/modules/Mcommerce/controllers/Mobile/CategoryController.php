            ...
            try {
                ...
                foreach($products as $product) {
                    ...
                    $data["collection"][] = array(
                        ...
                        "subtitle" => $product->getPrice() > 0 ? $product->formatPrice($product->getPrice() * (1 + $taxRate / 100)) : strip_tags(html_entity_decode($product->getDescription())),
                        "picture" => $picture,
