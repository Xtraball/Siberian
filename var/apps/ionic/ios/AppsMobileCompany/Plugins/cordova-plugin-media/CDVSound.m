...
- (void)create:(CDVInvokedUrlCommand*)command
{
    ...
    CDVAudioFile* audioFile = [self audioFileForResource:resourcePath withId:mediaId doValidation:NO forRecording:NO]; // AppsMobileCompany
    ...
    if (audioFile == nil) {
        ...
        NSURL* resourceUrl = [[NSURL alloc] initWithString:resourcePath]; // AppsMobileCompany
